            ...
            <div class="header">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        ...
                        <a href="<?php echo base_url('admin/' . $page . '/' . $emp_id); ?>" class="btn btn-primary">Edit This Profile</a>
                    </div>
                </div>
                <h5>
                    <?php
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($info['basic_info'][0]['emp_apointment_date'])) {
                                            if (!empty($info['basic_info'][0]['emp_apointment_date'])) {
                                                echo date('d/m/Y', $info['basic_info'][0]['emp_apointment_date']) . " ইং";
                                            }
                                        }
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($info['basic_info'][0]['emp_current_office_appointment_date'])) {
                                            if (!empty($info['basic_info'][0]['emp_current_office_appointment_date'])) {
                                                echo date('d/m/Y', $info['basic_info'][0]['emp_current_office_appointment_date']) . " ইং";
                                            }
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($info['basic_info'][0]['emp_recent_prev_designation'])) {
                                            if (!empty($info['basic_info'][0]['emp_recent_prev_designation'])) {
                                                echo $info['basic_info'][0]['emp_recent_prev_designation'];
                                            }
                                        }
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($info['basic_info'][0]['emp_recent_prev_joining_date'])) {
                                            if (!empty($info['basic_info'][0]['emp_recent_prev_joining_date'])) {
                                                echo date('d/m/Y', $info['basic_info'][0]['emp_recent_prev_joining_date']) . " ইং";
                                            }
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($info['basic_info'][0]['emp_birth_date'])) {
                                            echo date('d/m/Y', $info['basic_info'][0]['emp_birth_date']) . ' ইং';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($info['basic_info'][0]['emp_computer_skill'])) {
                                            if (!empty($info['basic_info'][0]['emp_computer_skill'])) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                        ...
                                        if (isset($salary_info[0]['stp_4_date_of_birth'])) {
                                            echo date('d/m/Y', $salary_info[0]['stp_4_date_of_birth']);
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($salary_info[0]['stp_4_first_joining_date'])) {
                                            echo date('d/m/Y', $salary_info[0]['stp_4_first_joining_date']);
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($salary_info[0]['stp_4_next_salary_increment_date'])) {
                                            echo date('d/m/Y', $salary_info[0]['stp_4_next_salary_increment_date']);
                                        }
                                        ?>
                                    </div>
                                </div>
