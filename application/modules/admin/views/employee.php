                            ...
                            <div role="tabpanel" class="tab-pane fade " id="qualification">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <?php
                                        if (isset($info['basic_info'][0]['emp_retirement_date'])) {
                                            echo ($info['basic_info'][0]['emp_retirement_date'] != 0) ? date('d-m-Y', $info['basic_info'][0]['emp_retirement_date']) . ' ইং' : '';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8"> 
                                        ...
                                        if (isset($salary_info[0]['stp_4_date_of_birth'])) {
                                            echo date('d-m-Y', $salary_info[0]['stp_4_date_of_birth']) . ' ইং';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($salary_info[0]['stp_4_first_joining_date'])) {
                                            echo date('d-m-Y', $salary_info[0]['stp_4_first_joining_date']) . ' ইং';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        if (isset($salary_info[0]['stp_4_next_salary_increment_date'])) {
                                            echo date('d-m-Y', $salary_info[0]['stp_4_next_salary_increment_date']) . ' ইং';
                                        }
                                        ?>
                                    </div>
                                </div>
