                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody class="body_content">
                            <tr>
                                ...
                                <td><input type="text" class="form-control date-picker" name="employeement_training_from[]" id="employeement_training_from" /></td>
                                <td><input type="text" class="form-control date-picker" name="employeement_training_to[]" id="employeement_training_to" /></td>
                                <td><input type="text" class="form-control" name="employeement_training_duration[]" id="employeement_training_duration" /></td>
