...
class Admin extends MY_Controller {
    ...
    public function save_user_info() {
        ...
        $data = array(
            ...
            'emp_apointment_date' => $this->input->post('emp_apointment_date'),
            'emp_current_office' => $this->input->post('emp_current_office'),
            'emp_promotion_date' => $this->input->post('emp_promotion_date'),
            'emp_current_office_appointment_date' => $this->input->post('emp_current_office_appointment_date'),
            ...
            'emp_recent_prev_joining_date' => $this->input->post('emp_recent_prev_joining_date'),
            ...
            'emp_computer_skill' => serialize($this->input->post('emp_computer_skill')),
            'emp_retirement_date' => $this->input->post('emp_retirement_date'),
        ...
        if (!empty($emp_name)) {
            ...
            for ($i = 0; $i < $total_office_info; $i++) {
                $office_info_single = array(
                    ...
                    'emp_office_from' => $this->input->post('emp_office_from')[$i],
                    'emp_office_to' => $this->input->post('emp_office_to')[$i],
            ...
            for ($i = 0; $i < $total_training_info; $i++) {
                $training_info_single = array(
                    ...
                    'employeement_training_from' => $this->input->post('employeement_training_from')[$i],
                    'employeement_training_to' => $this->input->post('employeement_training_to')[$i],
            ...
            $data_salary = array(
                ...
                'stp_4_date_of_birth' => $this->input->post('stp_4_date_of_birth'),
                'stp_4_first_joining_date' => $this->input->post('stp_4_first_joining_date'),
                ...
                'stp_4_next_salary_increment_date' => $this->input->post('stp_4_next_salary_increment_date'),
            );
    ...
    public function edit_en() {
        ...
        if (isset($user_id)) {
            if (is_numeric($user_id)) {
                $basic_info = $this->Admin_model->getByIdLnBasic('basic_info_en', $user_id, 'en');
                if (!empty($basic_info)) {
                    $info['basic_info'] = $basic_info;
    ...
    public function update_user_info() {
        ...
        for ($i = 0; $i < $total_office_info_new; $i++) {
            $office_info_single_new = array(
                ...
                'emp_office_from' => $this->input->post('emp_office_from_new')[$i],
                'emp_office_to' => $this->input->post('emp_office_to_new')[$i],
        ...
        for ($i = 0; $i < $total_training_info_new; $i++) {
            $training_info_single_new = array(
                ...
                'employeement_training_from' => $this->input->post('employeement_training_from_new')[$i],
                'employeement_training_to' => $this->input->post('employeement_training_to_new')[$i],
